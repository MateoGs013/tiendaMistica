...
<div class="admin-section-header">
    ...
    <a href="index.php?sec=blog_crear" class="btn-arc btn-arc--primary">
                ...
                <?php foreach ($blogs as $b): ?>
                    <tr>
                        ...
                        <td class="admin-table__actions">
                            <a href="index.php?sec=blog_editar&id=<?php echo $b['id_blog']; ?>" class="admin-action-link admin-action-link--edit">
                                ✏️ Editar
                            </a>
...
<?php else: ?>
    <div class="admin-empty-state">
        ...
        <a href="index.php?sec=blog_crear" class="btn-arc btn-arc--primary btn-arc--lg">
...
function confirmarBorrado(id, titulo) {
    showConfirm('¿Estás seguro de que quieres eliminar el blog "' + titulo + '"?\n\nEsta acción no se puede deshacer.', 'Confirmar eliminación').then(result => {
        if (result) {
            window.location.href = 'actions/blog_borrar_acc.php?id=' + id + '&confirmar=1';
        }
    });
}
</script>
