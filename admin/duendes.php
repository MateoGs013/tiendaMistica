...
<div class="admin-section-header">
    ...
    <a href="<?php echo admin_url('duende_crear'); ?>" class="btn-arc btn-arc--primary">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="admin-table__actions">
                                <a href="<?php echo admin_url('duende_editar', ['id' => $d['id_duende']]); ?>" class="admin-action-link admin-action-link--edit">
                                    ✏️ Editar
                                </a>
...
<?php else: ?>
    <div class="admin-empty-state">
        ...
        <a href="<?php echo admin_url('duende_crear'); ?>" class="btn-arc btn-arc--primary btn-arc--lg">
            <span>+ Crear Duende</span>
        </a>
    </div>
<?php endif; ?>
