...
<div class="admin-dashboard">
    <a href="admin/index.php?sec=duendes" class="admin-module-card">
    ...
    <a href="admin/index.php?sec=blogs" class="admin-module-card">
    ...
    <a href="admin/index.php?sec=pedidos" class="admin-module-card">
        <div class="admin-module-card__icon">📦</div>
    ...
    <a href="admin/index.php?sec=contactos" class="admin-module-card">
        <div class="admin-module-card__icon">✉️</div>
    ...
    <a href="admin/index.php?sec=usuarios" class="admin-module-card">
        <div class="admin-module-card__icon">👥</div>
