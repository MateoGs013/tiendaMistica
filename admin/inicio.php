...
<div class="admin-dashboard">
    <a href="index.php?sec=duendes" class="admin-module-card">
    ...
    <a href="index.php?sec=blogs" class="admin-module-card">
    ...
    <a href="index.php?sec=pedidos" class="admin-module-card">
        <div class="admin-module-card__icon">📦</div>
    ...
    <a href="index.php?sec=contactos" class="admin-module-card">
        <div class="admin-module-card__icon">✉️</div>
    ...
    <a href="index.php?sec=usuarios" class="admin-module-card">
        <div class="admin-module-card__icon">👥</div>
